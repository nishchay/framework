...
class Method extends BaseAnnotationDefinition
{
     ...
     */
    public function __construct($class, $method, $annotation, Controller $controller)
    {
    ...
    public function buildRoute(&$annotation)
    {
        ...
        if ($route !== null) {
            ...
            $annotation['route'] = array_merge($route['route'] ?? $route, $annotation['route'] ?? []);
    ...
    protected function setRoute($route)
    {
        $this->route = new Route(
                $this->class, $this->method, $route, $this->controller, array_key_exists('placeholder', $this->annotation), $this->isPatterned);
    }
     ...
     */
    protected function setNamedscope($namedScope)
    {
        $this->namedscope = new NamedScope($this->class, $this->method, $namedScope);
    }
